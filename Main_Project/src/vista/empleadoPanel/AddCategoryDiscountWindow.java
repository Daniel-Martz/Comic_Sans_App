...
import controladores.ControladorDescuentosCategoria;
...
public class AddCategoryDiscountWindow extends JDialog {
    ...
    public AddCategoryDiscountWindow(JFrame parent, Categoria cat, ControladorDescuentosCategoria ctrl) {
        ...
        JLabel lblTitulo = new JLabel("Discount for Category: " + cat.getNombre());
        ...
        btnConfirm.addActionListener(e -> {
            try {
                ...
                ctrl.confirmarAñadirDescuento(cat, d);
                dispose();
            } catch (Exception ex) {
    ...
    private void prefillData(Categoria c) {
        ...
        if (d instanceof Precio) {
            ...
            Cantidad cDesc = (Cantidad) d;
            txtBuyQty.setText(String.valueOf(cDesc.getNumeroComprados()));
            txtReceiveQty.setText(String.valueOf(cDesc.getNumeroRecibidos()));
