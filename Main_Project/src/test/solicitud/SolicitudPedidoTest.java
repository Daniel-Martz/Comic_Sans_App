...
class SolicitudPedidoTest {
  ...
  @Test
    ...
    assertTrue(solicitudPedido.getCostePedido() == 20 && solicitudPedido.getRecaudacionProductos().get(new SimpleEntry<LineaProductoVenta, Integer>(prod1, 3)) != null);
	}
  ...
  @Test
    ...
    assertTrue(solicitudPedido.getCostePedido() == 30 && solicitudPedido.getRecaudacionProductos().get(new SimpleEntry<LineaProductoVenta, Integer>(prod1, 3)) != null);
	}
