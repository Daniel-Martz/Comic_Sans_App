...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{../Diagramas/usuario.jpg}
\end{figure}
...
\subsection{Explicación del paquete aplicación}

\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{../Diagramas/aplicacion.jpg}
\end{figure}
...
A pesar de que el sistema de recomendaciones no es un paquete como tal, estando implementado con clases en varios paquetes, merece un apartado por sí solo. Como bien se sabe, el sistema de recomendación cuenta con 3 críterios cuya importancia es ajustable por el gestor. Estos criterios son:
\begin{itemize}
  \item Interés del cliente: para medir los objetos que pueden resultar de interés para un cliente particular hemos creado una clase Interes que irá asociada a cada cliente. En esta clase se guarda un mapa en el que a cada Producto en venta se le asocia un entero, cuanto mayor sea este entero más interés tendrá el cliente en ese producto. También se guarda otro mapa del mismo tipo que el anterior pero para productos de segunda mano. Además contiene otros dos atributos referentes al máximo interés de cada mapa, para evitar posibles problemas con el overflow y realizar compactaciones cuando sea necesario. \\
Los mapas anteriores serán actualizados cada vez que se realice una búsqueda o se haga una compra, de forma que los productos relacionados con las búsquedas o compras aumenten su interés.

\item Reseñas de productos: también existe un criterio relacionado con la puntuación que tiene cada producto, de forma que cuando se llame al método para obtener un ranking se creará otro mapa en el que a cada producto se le asociará su puntuación media.

\item Novedad productos: por otro lado, otro criterio hace referncia al tiempo en mercado de un producto, de manera que cuanto más nuevo sea más se recomendará. Para ello cuando se quiera obtener los productos recomendados, de manera interna se creará otro mapa que asocie a cada producto su id como entero, este id va creciendo cada vez que se crea un producto de forma que cuanto más nuevo sea un producto mayor id tendrá.
\end{itemize}

Para unificar los tres criterios, en el método para obtener el ranking en cada uno de los mapas se dividiran todos los valores asociados a productos entre el mayor valor de su respectivo mapa, para obtener doubles entre 0 y 1 y posteriormente se multplicaran por la importancia dependiendo del criterio al que pertenezcan. Por último se sumaran los tres criterios asociados a cada producto, dando lugar a un mapa de productos y doubles, del que tras ordenarlo de mayor a menor se obtendrán los N primeros productos los cuales se recomendarán.

Cabe destacar que para el ranking de productos de segunda mano solo se tendrá en cuenta el criterio del interés.

\subsubsection{Gestor}
Podrá configurar la importancia de cada criterio, así como el número de productos recomendados


\subsubsection{Cliente}
Cada cliente tendrá su objeto Interes asociado el cuál se irá actualizando tras cada búsqueda, compra o intercambio realizada por el cliente.

\subsection{Explicación del paquete producto}

\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{../Diagramas/producto.jpg}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{../Diagramas/descuento.jpg}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{../Diagramas/categoria.jpg}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{../Diagramas/notificacion.jpg}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{../Diagramas/solictidu.jpg}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{../Diagramas/filtro.jpg}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{../Diagramas/DiagramaSecuenciaPagarPedido.jpg}
\end{figure}
...
\item Pasarela de Pago: Se invoca al SistemaPago Diagramasnte el método procesarPago(...) pasando los datos de la tarjeta y el coste calculado. El resultado (validez) determina el flujo siguiente.
\end{itemize}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{../Diagramas/DIagramaSecuenciaBuscarProductosNuevos.jpg}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{../Diagramas/diagrama_estados_intercambio.jpg}
\end{figure}
...
En todo momento, los clientes tiene notificaciones cuando aceptan o rechazan una oferta y cuando se aprueba el intercambio. \\
El empleado tambien recibe notificaciones cuando se acepta un intercambio entre dos clientes.
\subsection{Pedido}
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{../Diagramas/diagrama_estados_PEDIDO.jpg}
\end{figure}
...
Todo comienza cuando se realiza el pedido, que queda a la espera de ser pagado; si el intento de pago falla,	el pedido se mantiene en ese mismo punto, aunque ahora también existe la opción de cancelar el pedido definitivamente en esta fase, terminando ahí su ciclo. Si continúa y el sistema confirma el cobro, el pedido avanza al estado de "pagado". \\
...
En todo momento, el cliente recibira notificaciones sobre el estado de su pedido y el empleado recibira otra sobre la gestion de un nuevo pedido.
\end{document}
